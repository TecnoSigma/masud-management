...
RSpec.describe 'EmployeePanel::AdministratorPanel::Dashboard', type: :request do
  describe '#index' do
    context 'when is administrator profile' do
      it 'renders administrator dashboard page with http status code 200' do
        ...
        get '/gestao/admin/dashboard/index'
